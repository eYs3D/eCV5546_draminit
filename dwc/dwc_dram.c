...
#include <eCV5546/LPDDR4/dwc_retention_lpddr4_eCV5546.txt>
#endif
#ifdef DRAM_TYPE_DDR4
#include <eCV5546/DDR4/dwc_retention_ddr4_eCV5546.txt>
#endif
#ifdef DRAM_TYPE_DDR3
#include <eCV5546/DDR3/dwc_retention_ddr3_eCV5546.txt>
#endif
...
void dwc_ddrphy_phyinit_main(void)
{
	...
	//runtimeConfig.RetEn = 1;
		...
		prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_3200_eCV5546_nayna\n");
		#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_3200_eCV5546_nayna.txt>
	#elif defined(MT53E1G32D2_A) || defined(BWMZCX32H2A)
		prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_rank1\n");
		#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_rank1.txt>
	#else
	#ifdef DRAM_X32
		prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_3200_eCV5546\n");
		#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_3200_eCV5546.txt>
	#elif defined(DRAM_X16)
		prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_3200_x16\n");
		#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_3200_x16.txt>
	#endif
	#endif
	#endif

	#ifdef SDRAM_SPEED_1333
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_2666_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_2666_eCV5546.txt>
	#endif

	#ifdef SDRAM_SPEED_1200
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_2400_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_2400_eCV5546.txt>
	#endif

	#ifdef SDRAM_SPEED_1066
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_2133_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_2133_eCV5546.txt>
	#endif

	#ifdef SDRAM_SPEED_933
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1866_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1866_eCV5546.txt>
	#endif

	#ifdef SDRAM_SPEED_800
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1600_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1600_eCV5546.txt>
	#endif

	#ifdef SDRAM_SPEED_733
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1466_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1466_eCV5546.txt>
	#endif

	#ifdef SDRAM_SPEED_666
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1333_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1333_eCV5546.txt>
	#endif

	#ifdef SDRAM_SPEED_600
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1200_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1200_eCV5546.txt>
	#endif

	#ifdef SDRAM_SPEED_533
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1066_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_1066_eCV5546.txt>
	#endif

	#ifdef SDRAM_SPEED_400
	prn_string("dwc_ddrphy_phyinit_out_lpddr4_train1d2d_800_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_ddrphy_phyinit_out_lpddr4_train1d2d_800_eCV5546.txt>
	#endif
	#endif
	...
	#include <eCV5546/DDR4/dwc_ddrphy_phyinit_out_ddr4_3200_train1d2d_rank1.txt>
	#endif

	#ifdef SDRAM_SPEED_1333
	#ifdef CHANGE_CLOCK
	prn_string("dwc_ddrphy_phyinit_out_ddr4_2666_2133_1866_1600_train1d2d_rank1\n");
	#include <eCV5546/DDR4/dwc_ddrphy_phyinit_out_ddr4_2666_2133_1866_1600_train1d2d_rank1.txt>
	#else
	#ifdef DRAM_X32
	prn_string("dwc_ddrphy_phyinit_out_ddr4_2666_train1d2d_rank1\n");
	#include <eCV5546/DDR4/dwc_ddrphy_phyinit_out_ddr4_2666_train1d2d_rank1.txt>
	#elif defined(DRAM_X16)
	prn_string("dwc_ddrphy_phyinit_out_ddr4_train1d2d_1GB\n");
	#include <eCV5546/DDR4/dwc_ddrphy_phyinit_out_ddr4_train1d2d_1GB.txt>
	#endif
	#endif
	#endif
	...
	#include <eCV5546/DDR4/dwc_ddrphy_phyinit_out_ddr4_2133_train1d2d_rank1_CL18_WL12.txt>
	#endif

	#ifdef SDRAM_SPEED_933
	prn_string("dwc_ddrphy_phyinit_out_ddr4_1866_train1d2d_rank1\n");
	#include <eCV5546/DDR4/dwc_ddrphy_phyinit_out_ddr4_1866_train1d2d_rank1.txt>
	#endif

	#ifdef SDRAM_SPEED_800
	prn_string("dwc_ddrphy_phyinit_out_ddr4_1600_train1d2d_rank1_CL_14\n");
	#include <eCV5546/DDR4/dwc_ddrphy_phyinit_out_ddr4_1600_train1d2d_rank1_CL_14.txt>
	#endif
	#endif
	...
	#include <eCV5546/DDR3/dwc_ddrphy_phyinit_out_ddr3_1866_1600_1333_1066_train1d_rank1.txt>
	#else
	prn_string("dwc_ddrphy_phyinit_out_ddr3_1866_train1d\n");
	#include <eCV5546/DDR3/dwc_ddrphy_phyinit_out_ddr3_1866_train1d.txt>
	#endif
	#endif

	#ifdef SDRAM_SPEED_800
	prn_string("dwc_ddrphy_phyinit_out_ddr3_1600_train1d\n");
	#include <eCV5546/DDR3/dwc_ddrphy_phyinit_out_ddr3_1600_train1d.txt>
	#endif

	#ifdef SDRAM_SPEED_666
	prn_string("dwc_ddrphy_phyinit_out_ddr3_1333_train1d\n");
	#include <eCV5546/DDR3/dwc_ddrphy_phyinit_out_ddr3_1333_train1d.txt>
	#endif

	#ifdef SDRAM_SPEED_533
	prn_string("dwc_ddrphy_phyinit_out_ddr3_1066_train1d_rank1\n");
	#include <eCV5546/DDR3/dwc_ddrphy_phyinit_out_ddr3_1066_train1d_rank1.txt>
	#endif
	#endif
