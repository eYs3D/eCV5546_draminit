...
int dwc_umctl2_init_before_ctl_rst(void)
{
...
#ifdef DRAM_X32
	prn_string("dwc_umctl2_lpddr4_1600_eCV5546_for_realchip\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_1600_eCV5546_for_realchip.txt>
#elif defined(DRAM_X16)
	prn_string("dwc_umctl2_lpddr4_1600_eCV5546_for_realchip_x16\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_1600_eCV5546_for_realchip_x16.txt>
#endif
#endif

#ifdef SDRAM_SPEED_1333
	prn_string("dwc_umctl2_lpddr4_1333_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_1333_eCV5546.txt>
#endif

#ifdef SDRAM_SPEED_1200
	prn_string("dwc_umctl2_lpddr4_1200_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_1200_eCV5546.txt>
#endif

#ifdef SDRAM_SPEED_1066
	prn_string("dwc_umctl2_lpddr4_1066_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_1066_eCV5546.txt>
#endif

#ifdef SDRAM_SPEED_933
	prn_string("dwc_umctl2_lpddr4_933_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_933_eCV5546.txt>
#endif

#ifdef SDRAM_SPEED_800
	prn_string("dwc_umctl2_lpddr4_800_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_800_eCV5546.txt>
#endif

#ifdef SDRAM_SPEED_733
	prn_string("dwc_umctl2_lpddr4_733_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_733_eCV5546.txt>
#endif

#ifdef SDRAM_SPEED_666
	prn_string("dwc_umctl2_lpddr4_666_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_666_eCV5546.txt>
#endif

#ifdef SDRAM_SPEED_600
	prn_string("dwc_umctl2_lpddr4_600_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_600_eCV5546.txt>
#endif

#ifdef SDRAM_SPEED_533
	prn_string("dwc_umctl2_lpddr4_533_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_533_eCV5546.txt>
#endif

#ifdef SDRAM_SPEED_400
	prn_string("dwc_umctl2_lpddr4_400_eCV5546\n");
	#include <eCV5546/LPDDR4/dwc_umctl2_lpddr4_400_eCV5546.txt>
#endif
#endif
	...
	#include <eCV5546/DDR4/Q654_DDR4_ASIC_SDRAM_DATARATE_3200.txt>
#endif

#ifdef SDRAM_SPEED_1333
#ifdef DRAM_X32
	prn_string("Q654_DDR4_ASIC_SDRAM_DATARATE_2666\n");
	#include <eCV5546/DDR4/Q654_DDR4_ASIC_SDRAM_DATARATE_2666.txt>
#elif defined(DRAM_X16)
	prn_string("Q654_DDR4_ASIC_SDRAM_DATARATE_2666_1GB\n");
	#include <eCV5546/DDR4/Q654_DDR4_ASIC_SDRAM_DATARATE_2666_1GB.txt>
#endif
#endif
	...
	#include <eCV5546/DDR4/Q654_DDR4_ASIC_SDRAM_DATARATE_2400_DDP.txt>
#else
	prn_string("Q654_DDR4_ASIC_SDRAM_DATARATE_2400\n");
	#include <eCV5546/DDR4/Q654_DDR4_ASIC_SDRAM_DATARATE_2400.txt>
#endif
#endif

#ifdef SDRAM_SPEED_933
	prn_string("Q654_DDR4_ASIC_SDRAM_DATARATE_1866\n");
	#include <eCV5546/DDR4/Q654_DDR4_ASIC_SDRAM_DATARATE_1866.txt>
#endif

#ifdef SDRAM_SPEED_800
	prn_string("Q654_DDR4_ASIC_SDRAM_DATARATE_1600\n");
	#include <eCV5546/DDR4/Q654_DDR4_ASIC_SDRAM_DATARATE_1600.txt>
#endif
#endif
	...
	#include <eCV5546/DDR3/Q654_DDR3_ASIC_SDRAM_DATARATE_1866.txt>
#endif

#ifdef SDRAM_SPEED_800
	prn_string("Q654_DDR3_ASIC_SDRAM_DATARATE_1600\n");
	#include <eCV5546/DDR3/Q654_DDR3_ASIC_SDRAM_DATARATE_1600.txt>
#endif

#ifdef SDRAM_SPEED_666
	prn_string("Q654_DDR3_ASIC_SDRAM_DATARATE_1333\n");
	#include <eCV5546/DDR3/Q654_DDR3_ASIC_SDRAM_DATARATE_1333.txt>
#endif

#ifdef SDRAM_SPEED_533
	prn_string("Q654_DDR3_ASIC_SDRAM_DATARATE_1066\n");
	#include <eCV5546/DDR3/Q654_DDR3_ASIC_SDRAM_DATARATE_1066.txt>
#endif
#endif
